...
namespace Hexa.NET.OpenGLES.INTEL
{
	public static unsafe partial class GLINTEL
	{
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<uint, uint*, void>)funcTable[2])(queryId, queryHandle);
			#else
			((delegate* unmanaged[Cdecl]<uint, nint, void>)funcTable[2])(queryId, (nint)queryHandle);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<uint*, void>)funcTable[5])(queryId);
			#else
			((delegate* unmanaged[Cdecl]<nint, void>)funcTable[5])((nint)queryId);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<uint, uint*, void>)funcTable[6])(queryId, nextQueryId);
			#else
			((delegate* unmanaged[Cdecl]<uint, nint, void>)funcTable[6])(queryId, (nint)nextQueryId);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<uint, uint, uint, byte*, uint, byte*, uint*, uint*, uint*, uint*, ulong*, void>)funcTable[7])(queryId, counterId, counterNameLength, counterName, counterDescLength, counterDesc, counterOffset, counterDataSize, counterTypeEnum, counterDataTypeEnum, rawCounterMaxValue);
			#else
			((delegate* unmanaged[Cdecl]<uint, uint, uint, nint, uint, nint, nint, nint, nint, nint, nint, void>)funcTable[7])(queryId, counterId, counterNameLength, (nint)counterName, counterDescLength, (nint)counterDesc, (nint)counterOffset, (nint)counterDataSize, (nint)counterTypeEnum, (nint)counterDataTypeEnum, (nint)rawCounterMaxValue);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<uint, GLPerfQueryDataFlags, int, void*, uint*, void>)funcTable[8])(queryHandle, flags, dataSize, data, bytesWritten);
			#else
			((delegate* unmanaged[Cdecl]<uint, GLPerfQueryDataFlags, int, nint, nint, void>)funcTable[8])(queryHandle, flags, dataSize, (nint)data, (nint)bytesWritten);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<byte*, uint*, void>)funcTable[9])(queryName, queryId);
			#else
			((delegate* unmanaged[Cdecl]<nint, nint, void>)funcTable[9])((nint)queryName, (nint)queryId);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<uint, uint, byte*, uint*, uint*, uint*, GLPerformanceQueryCapsMaskINTEL, void>)funcTable[10])(queryId, queryNameLength, queryName, dataSize, noCounters, noInstances, capsMask);
			#else
			((delegate* unmanaged[Cdecl]<uint, uint, nint, nint, nint, nint, GLPerformanceQueryCapsMaskINTEL, void>)funcTable[10])(queryId, queryNameLength, (nint)queryName, (nint)dataSize, (nint)noCounters, (nint)noInstances, capsMask);
			#endif
		}
