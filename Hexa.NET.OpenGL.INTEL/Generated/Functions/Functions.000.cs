...
{
	public static unsafe partial class GLINTEL
	{
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<uint, void>)funcTable[1])(queryHandle);
			#else
			((delegate* unmanaged[Cdecl]<uint, void>)funcTable[1])(queryHandle);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<uint, uint*, void>)funcTable[3])(queryId, queryHandle);
			#else
			((delegate* unmanaged[Cdecl]<uint, nint, void>)funcTable[3])(queryId, (nint)queryHandle);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<uint, void>)funcTable[4])(queryHandle);
			#else
			((delegate* unmanaged[Cdecl]<uint, void>)funcTable[4])(queryHandle);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<uint, void>)funcTable[5])(queryHandle);
			#else
			((delegate* unmanaged[Cdecl]<uint, void>)funcTable[5])(queryHandle);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<uint*, void>)funcTable[6])(queryId);
			#else
			((delegate* unmanaged[Cdecl]<nint, void>)funcTable[6])((nint)queryId);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<uint, uint*, void>)funcTable[7])(queryId, nextQueryId);
			#else
			((delegate* unmanaged[Cdecl]<uint, nint, void>)funcTable[7])(queryId, (nint)nextQueryId);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<uint, uint, uint, byte*, uint, byte*, uint*, uint*, uint*, uint*, ulong*, void>)funcTable[8])(queryId, counterId, counterNameLength, counterName, counterDescLength, counterDesc, counterOffset, counterDataSize, counterTypeEnum, counterDataTypeEnum, rawCounterMaxValue);
			#else
			((delegate* unmanaged[Cdecl]<uint, uint, uint, nint, uint, nint, nint, nint, nint, nint, nint, void>)funcTable[8])(queryId, counterId, counterNameLength, (nint)counterName, counterDescLength, (nint)counterDesc, (nint)counterOffset, (nint)counterDataSize, (nint)counterTypeEnum, (nint)counterDataTypeEnum, (nint)rawCounterMaxValue);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<uint, GLPerfQueryDataFlags, int, void*, uint*, void>)funcTable[9])(queryHandle, flags, dataSize, data, bytesWritten);
			#else
			((delegate* unmanaged[Cdecl]<uint, GLPerfQueryDataFlags, int, nint, nint, void>)funcTable[9])(queryHandle, flags, dataSize, (nint)data, (nint)bytesWritten);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<byte*, uint*, void>)funcTable[10])(queryName, queryId);
			#else
			((delegate* unmanaged[Cdecl]<nint, nint, void>)funcTable[10])((nint)queryName, (nint)queryId);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<uint, uint, byte*, uint*, uint*, uint*, GLPerformanceQueryCapsMaskINTEL, void>)funcTable[11])(queryId, queryNameLength, queryName, dataSize, noCounters, noInstances, capsMask);
			#else
			((delegate* unmanaged[Cdecl]<uint, uint, nint, nint, nint, nint, GLPerformanceQueryCapsMaskINTEL, void>)funcTable[11])(queryId, queryNameLength, (nint)queryName, (nint)dataSize, (nint)noCounters, (nint)noInstances, capsMask);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			return ((delegate* unmanaged[Cdecl]<uint, int, uint, int*, GLEnum*, void*>)funcTable[12])(texture, level, access, stride, layout);
			#else
			return (void*)((delegate* unmanaged[Cdecl]<uint, int, uint, nint, nint, nint>)funcTable[12])(texture, level, access, (nint)stride, (nint)layout);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<GLNormalPointerType, void**, void>)funcTable[13])(type, pointer);
			#else
			((delegate* unmanaged[Cdecl]<GLNormalPointerType, nint, void>)funcTable[13])(type, (nint)pointer);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<int, GLVertexPointerType, void**, void>)funcTable[15])(size, type, pointer);
			#else
			((delegate* unmanaged[Cdecl]<int, GLVertexPointerType, nint, void>)funcTable[15])(size, type, (nint)pointer);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<uint, int, void>)funcTable[16])(texture, level);
			#else
			((delegate* unmanaged[Cdecl]<uint, int, void>)funcTable[16])(texture, level);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<int, GLVertexPointerType, void**, void>)funcTable[17])(size, type, pointer);
			#else
			((delegate* unmanaged[Cdecl]<int, GLVertexPointerType, nint, void>)funcTable[17])(size, type, (nint)pointer);
			#endif
		}
