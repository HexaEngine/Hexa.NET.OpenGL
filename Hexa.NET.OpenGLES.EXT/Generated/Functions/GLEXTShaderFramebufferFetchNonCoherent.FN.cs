...
{
	public unsafe partial class GLEXTShaderFramebufferFetchNonCoherent : GLExtension, IDisposable
	{
		public const string ExtensionName = "GL_EXT_shader_framebuffer_fetch_non_coherent";

		public GLEXTShaderFramebufferFetchNonCoherent() : base(1)
		{
		}
		...
		{
			funcTable.Load(0, "glFramebufferFetchBarrierEXT");
		}
