...
namespace Hexa.NET.OpenGLES.AMD
{
	public static unsafe partial class GLAMD
	{
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<uint, int, int, GLInternalFormat, int, int, void>)funcTable[10])(renderbuffer, samples, storageSamples, internalformat, width, height);
			#else
			((delegate* unmanaged[Cdecl]<uint, int, int, GLInternalFormat, int, int, void>)funcTable[10])(renderbuffer, samples, storageSamples, internalformat, width, height);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<GLRenderbufferTarget, int, int, GLInternalFormat, int, int, void>)funcTable[11])(target, samples, storageSamples, internalformat, width, height);
			#else
			((delegate* unmanaged[Cdecl]<GLRenderbufferTarget, int, int, GLInternalFormat, int, int, void>)funcTable[11])(target, samples, storageSamples, internalformat, width, height);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<uint, byte, uint, int, uint*, void>)funcTable[12])(monitor, enable, group, numCounters, counterList);
			#else
			((delegate* unmanaged[Cdecl]<uint, byte, uint, int, nint, void>)funcTable[12])(monitor, enable, group, numCounters, (nint)counterList);
			#endif
		}
