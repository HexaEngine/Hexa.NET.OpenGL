...
{
	public unsafe partial class GLNVDrawBuffers : GLExtension, IDisposable
	{
		public const string ExtensionName = "GL_NV_draw_buffers";

		public GLNVDrawBuffers() : base(1)
		{
		}
		...
		{
			funcTable.Load(0, "glDrawBuffersNV");
		}
