...
{
	public unsafe partial class GLNVReadBuffer : GLExtension, IDisposable
	{
		public const string ExtensionName = "GL_NV_read_buffer";

		public GLNVReadBuffer() : base(1)
		{
		}
		...
		{
			funcTable.Load(0, "glReadBufferNV");
		}
