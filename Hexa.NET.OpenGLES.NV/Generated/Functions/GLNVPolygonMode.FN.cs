...
{
	public unsafe partial class GLNVPolygonMode : GLExtension, IDisposable
	{
		public const string ExtensionName = "GL_NV_polygon_mode";

		public GLNVPolygonMode() : base(1)
		{
		}
		...
		{
			funcTable.Load(0, "glPolygonModeNV");
		}
