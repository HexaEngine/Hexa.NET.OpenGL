...
{
	public unsafe partial class GLOESQueryMatrix : GLExtension, IDisposable
	{
		public const string ExtensionName = "GL_OES_query_matrix";

		public GLOESQueryMatrix() : base(1)
		{
		}
		...
		{
			funcTable.Load(0, "glQueryMatrixxOES");
		}
