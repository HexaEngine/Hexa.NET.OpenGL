...
{
	public unsafe partial class GLOESBlendFuncSeparate : GLExtension, IDisposable
	{
		public const string ExtensionName = "GL_OES_blend_func_separate";

		public GLOESBlendFuncSeparate() : base(1)
		{
		}
		...
		{
			funcTable.Load(0, "glBlendFuncSeparateOES");
		}
