...
{
	public unsafe partial class GLOESCopyImage : GLExtension, IDisposable
	{
		public const string ExtensionName = "GL_OES_copy_image";

		public GLOESCopyImage() : base(1)
		{
		}
		...
		{
			funcTable.Load(0, "glCopyImageSubDataOES");
		}
