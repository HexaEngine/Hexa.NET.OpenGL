...
{
	public unsafe partial class GLOESPointSizeArray : GLExtension, IDisposable
	{
		public const string ExtensionName = "GL_OES_point_size_array";

		public GLOESPointSizeArray() : base(1)
		{
		}
		...
		{
			funcTable.Load(0, "glPointSizePointerOES");
		}
