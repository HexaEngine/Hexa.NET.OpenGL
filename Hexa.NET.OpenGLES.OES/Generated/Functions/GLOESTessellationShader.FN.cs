...
{
	public unsafe partial class GLOESTessellationShader : GLExtension, IDisposable
	{
		public const string ExtensionName = "GL_OES_tessellation_shader";

		public GLOESTessellationShader() : base(1)
		{
		}
		...
		{
			funcTable.Load(0, "glPatchParameteriOES");
		}
