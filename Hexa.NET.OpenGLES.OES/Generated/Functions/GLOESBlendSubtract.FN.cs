...
{
	public unsafe partial class GLOESBlendSubtract : GLExtension, IDisposable
	{
		public const string ExtensionName = "GL_OES_blend_subtract";

		public GLOESBlendSubtract() : base(1)
		{
		}
		...
		{
			funcTable.Load(0, "glBlendEquationOES");
		}
