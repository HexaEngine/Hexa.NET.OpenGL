...
{
	public unsafe partial class GLARBDirectStateAccess : GLExtension, IDisposable
	{
		public const string ExtensionName = "GL_ARB_direct_state_access";

		public GLARBDirectStateAccess() : base(97)
		{
		}
